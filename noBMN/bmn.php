        ...
        <div class="menuBoxInner biblioIcon">
            ...
            <div class="sub_section">
                <div class="btn-group">
                    ...
                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=detail"
                       class="btn btn-default"><?php echo __('Add New Bibliography'); ?></a>
                </div>
                <form name="search" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="search" method="get"
...
if (isset($_GET['action']) && $_GET['action'] == 'history') {
    ...
    /* Form Element(s) */
    $form->addTextField('text', 'no_bmn', 'No BMN', $rec_d['no_bmn'] ?? '');
    // biblio title
